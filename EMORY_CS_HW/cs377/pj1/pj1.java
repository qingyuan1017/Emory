...
/*THIS CODE IS MY OWN WORK, IT WAS WRITTEN WITHOUT CONSULTING A TUTOR OR CODE WRITTEN BY OTHER STUDENTS - Qingyuan Zhang*/
...
public class pj1
{
   ...
   for ( int i = 0; i < n_fields; i++ )
	   {
	      if ( type.equals(dataDes[i].fieldName) )
	      {
	    	  if ( dataDes[i].fieldType.equals("I") )
	          {
	             /* --------------------------------------------------------
	                Field i is an integer, use i_buf[i] to sum the value
	                -------------------------------------------------------- */
	             sum = sum + i_buf[i];
	          ...
	          { 
	             /* --------------------------------------------------------
	                Field i is an Double, use d_buf[i] to sum the value
	                -------------------------------------------------------- */
	        	  sum = sum + d_buf[i];
	          ...
	          {
	         	 /* --------------------------------------------------------
	              Field i is an String, can not be sumed
	              -------------------------------------------------------- */
	           System.out.print( "String can not be sumed ");
      ...
      for ( int i = 0; i < n_fields; i++ )
      {
         ...
         {  
            ...
            System.out.print( c_buf[i] + " ");
        	 ...
        	 /* --------------------------------------------------------
             Field d is an double, use d_buf[i] to store the value
             -------------------------------------------------------- */
